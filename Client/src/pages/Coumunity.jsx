...
const Coumunity = () => {
  ...
  return (
    <div className='p-6 pt-12 xl:px-12 2xl:px-20 w-full max-auto h-full overflow-y-scroll'>
      ...
      :
      (
        <div className='p-6 pt-12 xl:px-12 2xl:px-20 w-full flex items-center justify-center'>
          <h2 className='text-xl font-semibold mb-6 text-gray-800'>oops!! No images🥲</h2>
        </div>
      )
      }
